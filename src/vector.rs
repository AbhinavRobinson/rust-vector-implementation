...
mod tests {
    ...
    fn test_new_vector() {
        ...
        assert_eq!(vector.cap(), 0);
        assert_eq!(vector.len, 0);
        assert_eq!(vector.buf.ptr, NonNull::dangling());
    }
    ...
    fn test_grow() {
        ...
        vector.buf.grow();
        assert_eq!(vector.cap(), 1);
        assert!(NonNull::new(vector.ptr()).is_some());
        vector.buf.grow();
        assert_eq!(vector.cap(), 2);
        vector.buf.grow();
    ...
    fn test_push_pop() {
        ...
        assert_eq!(vector.push(1), 1);
        assert_eq!(vector.len, 1);
        assert_eq!(vector.cap(), 1);

        assert_eq!(vector.push(2), 2);
        assert_eq!(vector.len, 2);
        assert_eq!(vector.cap(), 2);

        assert_eq!(vector.push(3), 3);
        assert_eq!(vector.len, 3);
        assert_eq!(vector.cap(), 4);

        assert_eq!(vector.push(4), 4);
